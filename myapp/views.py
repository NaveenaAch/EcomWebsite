...
def tflite_detect_images(modelpath, imgpath, lblpath, min_conf=0.8, ocr_conf_threshold=0.0, txt_only=False):
...
def predict(request):
    ...
    if user_profile.tasbir:
        ...
        ocr_conf_threshold = 0.0 # Set OCR confidence threshold
